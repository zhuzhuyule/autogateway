...
type SystemSettings struct {
	...
	StreamIdleTimeout     int    `json:"stream_idle_timeout" default:"0" name:"config.stream_idle_timeout" category:"config.category.request" desc:"config.stream_idle_timeout_desc" validate:"min=0"`
