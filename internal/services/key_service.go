...
func (s *KeyService) TestModelConnectivity(group *models.Group, modelName, modality string) (*keypool.ModelTestResult, error) {
	return s.KeyValidator.TestModelConnectivity(group, modelName, modality)
}
