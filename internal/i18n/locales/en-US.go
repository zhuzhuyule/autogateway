...
var MessagesEnUS = map[string]string{
	...
	"config.failover_status_codes_desc":      "Upstream HTTP status codes that trigger retry / failover. Supports single values and ranges separated by commas, e.g. 400-403,405-999,250-260. The default excludes 404; alias-routed 404s still trigger failover automatically.",
