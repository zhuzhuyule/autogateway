export default {
  ...
  modelcatalog: {
    ...
    freeOnly: "仅看免费",
    freeTag: "免费",
    statsLine: "共 {total} · 显示 {filtered} · 免费 {free}",
  },
  dedup: {
    title: "模型去重",
    modelName: "模型名称",
  ...
  v3: {
    ...
    newGroupTitle: "新建分组",
    newGroupSubPick: "选一个免费 Provider 开始",
    ...
    step3Title: "粘贴并启用",
    step3Sub: "保存前会先测试",
    getKeyTitle: "从 {provider} 获取一个免费 key",
  ...
  v5: {
    ...
    noKeysSubWithProvider: "去 Provider 拿一个免费 key，再粘到这里就能开始使用。",
