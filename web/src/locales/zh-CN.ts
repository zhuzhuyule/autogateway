export default {
  ...
  sync: {
    ...
    syncKey: "同步密钥 (Peer Token)",
    syncKeyHint: "对端 SyncPeer 表里写入的同一个 token",
    syncApiKeys: "同步 API Keys",
    apiKeysWarningTitle: "高危: 跨节点同步 API Keys",
    apiKeysWarningBody:
      "开启后, 本端的全部 API Keys 都会以加密形式推送给对端. 一旦对端被入侵或对端 SyncKey 泄露, 你的全部上游凭证都会失守. 请仅在两端都在你自己掌控的可信网络中开启.",
    confirmPhrasePrompt: "请在下方输入确认词以激活保存:",
    confirmPhraseError: "确认词不匹配, 保存已阻止",
    status: "状态",
    statusConnected: "已连接",
