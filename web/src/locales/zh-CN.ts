export default {
  ...
  aliases: {
    ...
    health: {
      ...
      enable: "启用",
      open: "打开",
      hint_unexposed: "分组是 specified 模式, 但该模型不在暴露列表里 —— 选路会跳过它。",
      hint_blocked: "该模型在分组的黑名单里, 无视路由模式一律拒绝。",
      hint_disabled: "候选被手动停用, 不参与选路。",
      hint_empty: "别名一个候选都没有, 调用时会直接 404。",
    },
    // 编辑抽屉 (AliasEditDrawer.vue)
    edit: {
      title: "编辑别名",
