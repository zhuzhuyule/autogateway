export default {
  ...
  keys: {
    ...
    priorityHint: "选路层级:数值越小越优先。该层全部不可用(熔断/无可用密钥)时才降到下一层;同层内按权重分配。默认 100。",
  ...
  v3: {
    ...
    modeSpecifiedHint: "指定 = 白名单:仅「已暴露」段的模型对外可调,可拖拽排序、加别名;下方「上游全部」是候选池",
    blocked: "黑名单",
    block: "加入黑名单",
    unblock: "解除拉黑",
    exposedModels: "已暴露",
    ...
    testModalityTip: "选择测试模态: 自动识别按模型能力(图像生成/视觉/文本)分别构造探活请求, 或强制指定一种",
    probeShortChat: "文本",
    probeShortImage: "图像",
    probeShortVision: "视觉",
    probeShortTts: "合成",
