export default {
  ...
  keys: {
    ...
    clickToCopy: "点击复制",
    urlCopied: "地址已复制到剪贴板",
    deleteGroupFailed: "删除分组失败，请稍后重试",
    keyCount: "密钥数量",
    activeKeyCount: "有效密钥数",
    invalidKeyCount: "无效密钥数",
    hourlyRequests: "1小时请求",
    hourlyFailedRequests: "近1小时失败请求",
    hourlyFailureRate: "近1小时失败率",
    dailyRequests: "24小时请求",
    dailyFailedRequests: "近24小时失败请求",
    dailyFailureRate: "近24小时失败率",
    weeklyRequests: "近7天请求",
    weeklyFailedRequests: "近7天失败请求",
    weeklyFailureRate: "近7天失败率",
    detailInfo: "详细信息",
    basicInfo: "基础信息",
    displayName: "显示名称",
    channelType: "渠道类型",
