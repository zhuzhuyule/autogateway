export default {
  ...
  keys: {
    ...
    deleteGroupFailed: "グループの削除に失敗しました、再試行してください",
    keyCount: "キー数",
    activeKeyCount: "有効キー数",
    invalidKeyCount: "無効キー数",
    hourlyRequests: "1時間リクエスト",
    hourlyFailedRequests: "1時間失敗リクエスト",
    hourlyFailureRate: "1時間失敗率",
    dailyRequests: "24時間リクエスト",
    dailyFailedRequests: "24時間失敗リクエスト",
    dailyFailureRate: "24時間失敗率",
    weeklyRequests: "7日間リクエスト",
    weeklyFailedRequests: "7日間失敗リクエスト",
    weeklyFailureRate: "7日間失敗率",
    detailInfo: "詳細情報",
    basicInfo: "基本情報",
    displayName: "表示名",
    ...
    copyGroupFailed: "グループのコピーに失敗しました。後でもう一度試してください",
    ...
    weightTooltip:
      "ロードバランシングの重み、値が高いほど選択確率が高くなります。例：重み2のアップストリームは重み1の2倍選択されやすい",
