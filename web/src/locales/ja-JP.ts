export default {
  ...
  keys: {
    ...
    keyManagement: "キー管理",
    createGroup: "Provider を追加",
    createAggregateGroup: "集約 Provider を追加",
    ...
    groupNameAutoRenamed: "「{from}」は使用中のため、「{to}」に自動変更しました",
    ...
    editWeight: "ウェイトを編集",
    editWeightAndPriority: "ウェイトと優先度を編集",
    ...
    enterPriority: "優先度を入力してください",
    priorityHint:
      "ルーティング階層:数値が小さいほど優先されます。この階層が全て利用不可(サーキットオープン/有効なキーなし)のときのみ次の階層に降ります。同一階層内はウェイトで分配されます。既定値は 100。",
    weightCannotBeNegative: "ウェイトは負の値にできません",
    priorityCannotBeNegative: "優先度は 1 以上にしてください",
    weightMaxExceeded: "ウェイトは1000を超えることはできません",
    priorityMaxExceeded: "優先度は 1000 を超えることはできません",
    newWeight: "新しいウェイト",
    newPriority: "新しい優先度",
    ...
    multiUpstreamTooltip:
      "同一プロバイダーの等価な複数 base URL を重みで束ねます (自前クラスタ・マルチリージョン・主待機). 90% のケースは 1 つで十分なので、ウェイトと追加ボタンは既定で非表示です.",
    ...
    invalidGroup: "無効なグループのため保存できません",
    invalidAggregateGroup: "無効な集約グループのため保存できません",
    enterKeysPlaceholder: "キーを入力、一行に一つ；「key,備考」で個別にラベル可",
    labelFormatHint:
      "一行に一つのキー。任意：キーの後にカンマと備考を付けるとラベルになります（例：sk-xxx,本番）。",
    editLabelTip: "クリックしてラベルを編集",
    addLabel: "ラベル追加",
    addLabelPlaceholder: "このキーに名前を付ける…",
    deleteKeysWarning: "以下のキーはこのグループから完全に削除されます。この操作は取り消せません。",
  ...
  settings: {
    ...
    backup: {
      ...
      exportWarnHead: "バックアップファイルは入力したパスワードで暗号化されます。",
      exportWarnBold: "パスワードを失うと復元できません。",
      exportWarnTail: "ファイルと一緒に大切に保管してください。",
      exportPasswordPlaceholder: "バックアップパスワード（8文字以上）",
      exportPasswordAria: "バックアップパスワード",
      randomBtn: "ランダム生成",
      downloadBtn: "バックアップをダウンロード",
      msgPasswordShort: "パスワードは8文字以上必要です。",
      msgExportSuccess: "バックアップをダウンロードしました。パスワードを安全に保管してください。",
      msgExportFailed: "エクスポート失敗：{detail}",

      restoreTitle: "バックアップから復元",
      restoreWarn: "復元前に現在の設定をエクスポートすることを強く推奨します。",
      chooseFile: ".acb ファイルを選択",
      restorePasswordPlaceholder: "バックアップパスワード",
      restorePasswordAria: "バックアップパスワード",
      previewBtn: "プレビュー",
      msgPickFile: ".acb ファイルを選択しパスワードを入力してください。",
      msgPreviewFailed: "プレビュー失敗：{detail}",

      fieldSchema: "Schema",
      fieldExportedAt: "エクスポート日時",
      fieldGroups: "グループ",
      fieldApiKeys: "API キー",
      fieldAliases: "エイリアス",
      fieldSettings: "システム設定",
      fieldSubGroups: "サブグループ",
      conflictSuffix: "（{n} 件の競合）",

      strategyLabel: "競合解決：",
      strategyMerge: "マージ（ビジネスキーで upsert、既存フィールドは上書き）",
      strategySkip: "スキップ（ローカルを全保持、新規のみ追加）",
      strategyReplaceTitle: "置換",
      strategyReplaceDesc: "（非システムグループとそのキー/エイリアスを削除してから取り込み）",

      replaceWarn:
        "置換すると {groups} グループ、{keys} キー、{aliases} エイリアスが削除されます。下に DELETE と入力して確認してください。",
      deletePlaceholder: "DELETE と入力して確認",
      deleteAria: "DELETE と入力して置換を確認",
      applyBtn: "インポート実行",
      msgTypeDelete: "大文字の DELETE を入力して置換を確認してください。",
      msgImportSuccess: "インポート完了：グループ {groups}、キー {keys}、エイリアス {aliases}",
      msgImportFailed: "インポート失敗：{detail}",
    },
  },
  footer: {
    checking: "確認中...",
  ...
  modelcatalog: {
    ...
    onlyRecommended: "おすすめのみ",
    recommendedTip: "おすすめ：安定して使えるモデル",
    registryOnly: "registry only",
    registryOnlyTip: "FreeModels レジストリには登録されていますが、対応する group が未設定です。",
    avgMsTip: "全工程の所要時間 · 24h 平均（ストリーミング応答時間を含む）",
    costChipTip: "定価換算コスト · 24h(無料ソースは使用量トークン表示)",
  },
  dedup: {
    title: "モデル重複排除",
    subtitle: "複数グループに重複している同名モデルをエイリアス候補プールに統一できます",
    modelName: "モデル名",
    sourceGroups: "ソースグループ",
    candidates: "エイリアス候補",
    suggestedAlias: "推奨エイリアス",
    aliasPlaceholder: "エイリアス名",
    createAlias: "エイリアスを作成",
    createAliasTitle: "エイリアスに統一",
    createAliasConfirm: "「{model}」のエイリアスを作成し、選択したグループを候補プールにします",
    pleaseEnterAlias: "エイリアス名を入力してください",
    selectAtLeastOne: "少なくとも1つの候補グループを選択してください",
    createdN: "{n} 行のエイリアスを作成しました",
    partialFailures: "{n} 行が失敗しました",
  ...
  aliases: {
    ...
    edit: {
      ...
      moveUp: "上へ",
      moveDown: "下へ",
      namePlaceholder: "エイリアス名",
      orderHint: "並び順は優先順位です。重みが同じ場合の順序のみを決め、加重配分は変わりません。",
      enabledOn: "ルーティング対象",
      enabledOff: "無効（ルーティングされません）",
      empty: "候補がありません。下からグループとモデルを選んで追加してください。",
      pickGroup: "グループを選択",
      pickModel: "モデルを選択",
      add: "追加",
      needGroupAndModel: "先にグループとモデルを選択してください",
      duplicateCandidate: "このグループには既に同じモデルがあります",
      needAtLeastOne: "候補を最低 1 件残してください",
      discardTitle: "未保存の変更を破棄しますか？",
      discardConfirm: "ドロワーでの変更は保存されていないため失われます。",
      discard: "破棄",
      deleteAlias: "エイリアスを削除",
      deleteTitle: "このエイリアスを削除しますか？",
      deleteConfirm:
        "{alias} の候補 {n} 件をすべて削除します。このエイリアスは呼び出せなくなります。",
      deletedTitle: "{alias} を削除しました",
      deletedUndo: "候補 {n} 件を削除しました。",
      undo: "元に戻す",
      undone: "復元しました",
    },
    quick: {
      ...
      selectionCountWithDupe: "{n} 件選択 (うち {dupe} 件は既に該当別名)",
      bulkSelectAll: "全選択",
      bulkClear: "クリア",
      ...
      errors: {
        DUPLICATE_RESOURCE:
          "同じモデルマッピングが既に存在します。重複をはずして再送信してください",
        VALIDATION_FAILED: "リクエストパラメータが不正です",
        INVALID_JSON: "リクエスト形式が不正です",
        DATABASE_ERROR: "データベースエラー、後ほど再試行してください",
        INTERNAL_SERVER_ERROR: "サーバー内部エラー",
        BAD_REQUEST: "リクエストが無効です",
        UNKNOWN: "送信に失敗しました、再度お試しください",
      },
    },
  },
  v3: {
    ...
    newGroupTitle: "Provider を追加",
    officialChip: "OFFICIAL",
    freeChip: "FREE",
    formGroupName: "グループ名",
    formDisplayName: "表示名",
    formBaseUrl: "Base URL",
    formChannelType: "チャネルタイプ",
    channelOpenAICompat: "OpenAI 互換",
    channelOpenAIResponseCompat: "OpenAI Response 互換",
    channelAnthropicCompat: "Anthropic 互換",
    channelGeminiCompat: "Google Gemini 互換",
    channelHint: "下に表示する Provider テンプレートを決定",
    noTemplateForChannel:
      "このチャネルのテンプレート未収録 — フォーム直入力でカスタム Provider を作成可能",
    optional: "任意",
    keysPlaceholder: "API Key を 1 つ以上貼り付け (1 行 1 つ or カンマ区切り)",
    createAndContinue: "作成して設定を続ける →",
    createProvider: "Provider を作成",
    newGroupSubV2: "Key を貼り付けて自動識別、またはテンプレート選択 / 手動設定",
    sectionProvider: "Provider",
    sectionKeys: "API Keys",
    sectionConfirm: "確認",
    sectionDetails: "Provider 情報",
    groupNameTaken: "このグループ名は既に使用されています、別名にしてください",
    searchProviderPlaceholder: "Provider 名で検索...",
    searchNoMatch: "一致する Provider なし — フォームでカスタム追加可能",
    recommended: "推奨",
    otherFree: "その他の無料",
    showMoreFree: "もっと見る ({n}) ▼",
    customMode: "手動設定 (テンプレート不要)",
    customModeActive: "手動モード有効",
    formCustomProvider: "カスタム Provider",
    formTestModel: "テストモデル",
    testModelOptional: "任意, 詳細画面で後で設定可",
    summaryExpand: "展開して編集",
    summaryCollapse: "折りたたむ",
    summaryKeyCount: "{n} 個の Key",
    summaryNoKey: "Key なし (後で追加可)",
    smartLowConfidence: "{name} の Key のようですが、確証なし",
    keysPlaceholderV2: "(任意) API Key を 1 つ以上貼り付け (1 行 1 つ or カンマ区切り)",
    cantCreateHint: "名称と Base URL を入力してください",
    ...
    chooseProvider: "無料 Provider",
    providersAvailable: "個利用可能",
    officialProviders: "公式 Provider",
    officialProvidersAvailable: "個公式",
    customProviderGroupLabel: "カスタム",
    customProviderTitle: "⚙️ カスタム",
    customProviderDesc: "任意の OpenAI / Anthropic / Gemini 互換エンドポイントに接続",
    customChip: "CUSTOM",
    customTestModelPlaceholder: "例: gpt-4o (任意)",
    refetchModels: "再取得",
    refetchModelsTip: "現在の base_url とキーを使って上流の利用可能モデルを取得",
    refetchNeedBaseUrlKey: "先に base_url とキーを入力してください",
    probedModelsOk: "取得成功 — {n} 件のモデル",
    probedModelsFail: "取得失敗: {err}",
    selected: "選択済み",
    useThis: "これを使う",
    getKey: "Key 取得",
    newGroupFootHint: "Provider 追加後、詳細画面で Key を追加・モデル到達性をテストできます。",
    docs: "ドキュメント",
    editNotes: "メモを編集",
    ...
    aliasPendingTitle: "選択済み",
    aliasPendingHint:
      "下のモデルの + をクリックして一時追加。グループを跨いで複数選択し、最後に一括確定できます",
    aliasPendingConfirm: "{n} 件の追加を確定",
    aliasAlreadyBound: "この別名にバインド済み",
    aliasBlockedTip: "このモデルはブラックリスト登録中のため、ルーティングされません",
    ...
    editMappingTitle: "モデルマッピングを編集",
    realModelLabel: "実モデル ID",
    weightLabel: "重み",
    priorityLabel: "優先度",
    enabledLabel: "有効化",
    modelConfig: "モデル設定",
    ...
    modeSpecified: "指定",
    modePassthroughHint:
      "透過 = 全許可:上流が申告するモデルはすべて呼び出し可能。ホワイトリストによる絞り込みなし",
    modeSpecifiedHint:
      "指定 = ホワイトリスト:「公開中」セクションのモデルのみ呼び出し可能。並べ替え・別名付与ができ、下の「上流全体」は候補プール",
    blocked: "ブラックリスト",
    block: "ブラックリストに追加",
    unblock: "ブラック解除",
    exposedModels: "公開中",
    exposedHint:
      "外部から呼び出せるホワイトリスト — 呼び出し可能なモデルはこの一覧のみ。ドラッグで並べ替え、別名を追加できます",
    upstreamAll: "未公開",
    upstreamHint:
      "まだ公開していない上流モデル — ここから上の「公開中」ホワイトリストに追加できます",
    upstreamEmpty: "上流のモデルリストが空です — 先に更新をクリックしてください",
    noExposedModels: "公開中のモデルはまだありません — 下から追加してください",
    allExposed: "上流モデルはすべて公開済み — 追加できる項目はありません",
    addToExposed: "追加",
    alreadyExposed: "追加済み",
    testModel: "疎通テスト",
    testModelTesting: "テスト中…",
    modelTestOk: "{model} 成功 · {ms}ms",
    modelTestFail: "{model} 失敗 · {err}",
    testJustNow: "たった今",
    testMinAgo: "{n} 分前",
    testHourAgo: "{n} 時間前",
    bulkTestBtn: "一括テスト ({n})",
    bulkTestRunning: "テスト中…",
    bulkTestTip: "同時実行数 3、テスト中の項目はスキップ",
    testModalityAuto: "自動認識",
    testViaModality: "{mode} で",
    testModalityChat: "テキスト Chat",
    testModalityImage: "画像生成",
    testModalityVision: "ビジョン入力",
    testModalityTts: "音声合成 TTS",
    testModalityAsr: "音声認識 ASR",
    testModalityTip:
      "テストモダリティの選択: 自動認識はモデルの能力（画像生成/ビジョン/テキスト）に応じて生存確認リクエストを組み立てます。1 つに手動固定も可能",
    probeShortChat: "テキスト",
    probeShortImage: "画像",
    probeShortVision: "ビジョン",
    probeShortTts: "合成",
    probeShortAsr: "認識",
    probeChipAuto:
      "プローブ形態: {mode}（モデルの能力から自動認識、クリックで 1 つに固定できます）",
    probeChipManual: "プローブ形態: {mode}（手動で固定済み、クリックで自動認識に戻せます）",
    bulkTestStart: "{n} 個のモデルのテストを開始しました",
    bulkTestDoneOk: "{n} 個のモデルすべて成功",
    bulkTestDoneMixed: "{ok} 成功 · {fail} 失敗",
    removeFromExposed: "公開中から削除",
    allModelsTitle: "全モデル",
    paid: "有料",
    alias: "別名",
    aliasUnexposed: "無効",
    aliasUnexposedTip:
      "ターゲットグループが「指定」モードで {model} が公開中リストに含まれていないため、この別名はルーティング時にスキップされます。そのグループの「モデル」タブでこのモデルを追加すると復元できます。",
    routingPersistDrift:
      "バックエンドが新しいフィールドを認識していません — 再ビルドしてサービスを再起動してください。変更はローカルにのみ保存されています",
    smartDetect: "スマート認識",
    smartDetectPlaceholder: "API キーを貼り付け — Provider を自動マッチング…",
    smartDetectMatch: "{provider} を検出（{hint}）",
    smartApply: "自動選択して続行",
    smartNoMatch: "Provider を認識できません — 下から手動で選択してください",
    aliasUnexposedFixTip:
      "対応するグループの鍵ページへジャンプし、該当モデルをハイライト（右上の +追加 ボタンで修復）",
    aliasJumpToModel: "ここへジャンプ →",
    aliasJumpToModelTip: "このモデルの鍵ページへジャンプしてハイライト",
    modelClickToCopy: "クリックして model ID をコピー",
    modelCopied: "コピー完了",
    aliasAvgMsTip: "全工程の所要時間 · 24h 平均（ストリーミング応答時間を含む）",
    aliasCostTip: "換算コスト · 24h（無料ソースはトークン使用量を表示）",
    // 候補ステータス: この候補がルーティングされない理由。
    aliasStateUsable: "利用可",
    aliasStateDisabled: "無効化済み",
    aliasStateUnexposed: "未公開",
    aliasStateBlocked: "ブロック済み",
    aliasUnusableN: "利用不可 ({n})",
    aliasFix: "修復",
    aliasDisabledTip: "この候補は手動で無効化されており、ルーティングされません",
  },
  v5: {
    // Aliases ビュー — 未識別モデル提案バナー
    suggestionsTitle: "最近のリクエストで未知のモデルを検出 — クリックでエイリアスを作成",
    suggestionsDismiss: "このセッション中は非表示",
    suggestionsEmpty: "今すぐ提案できるエイリアスはありません。",
    ...
    maExistingTitle: "バインド済み別名",
    maAddTitle: "別名を追加",
    maAddHint:
      "Enter または + クリックで追加; 既存の再利用 = 現在のモデルをその別名の候補プールに追加",
    maDeleteConfirm: "別名 {alias} を削除しますか?",
    maInputPlaceholder: "別名を入力、Enter または + クリックで追加",
    maPendingLbl: "作成予定",
    maQuickPickLbl: "既存を再利用",
    maAlreadyBound: "バインド済み: {alias}",
  ...
  sync: {
    ...
    enable: "同期を有効化",
    enableHint:
      "有効化すると、下記のすべての Peer と設定(グループ/別名/API キー)をリアルタイムに双方向同期します。個別オプションは不要です。",
    syncSecret: "グローバル暗号鍵",
    syncSecretHint:
      "全ノードで同一の鍵を設定してください。ペイロードは AES-GCM でエンドツーエンド暗号化され、経路漏洩でも解読不能です。",
    syncSecretPlaceholder: "16 文字以上の強いランダム文字列",
    configSaved: "同期設定を保存しました",
    peers: "同期ノード",
    addPeer: "ノード追加",
    peerName: "ノード名",
    peerUrl: "ノード URL",
    peerEditTitle: "同期ノード設定",
    syncKey: "ノードアクセストークン",
    syncKeyHint: "対向ノードが本ノードに発行したトークン、WS/HTTP 握手認証に使用",
    myUrl: "本ノード URL",
    myIdentity: "本ノード ID フィンガープリント",
    shareWithPeer: "対向ノードが本ノードを追加する際に必要な情報",
    identityHint:
      "上記2項目を対向ノード管理者に共有: URL を「ノード URL」に、フィンガープリントを「対向ノード期待フィンガープリント」に貼り付け. 秘密鍵は本機を離れない.",
    syncSecretRequiredWhenEnabled: "同期を有効化するにはグローバル暗号鍵の設定が必須です",
    pinnedFingerprint: "対向ノード期待フィンガープリント",
    pinnedFingerprintPlaceholder: "例: aB3xK4p9Lm2q",
    pinnedFingerprintHint:
      "対向ノードの UI に表示される「本ノード ID フィンガープリント」. 握手時に実際の公開鍵フィンガープリントと一致するか検証, 不一致なら接続拒否. 空欄 = 初回接続信頼 (TOFU).",
    status: "状態",
    ...
    loadFailed: "読み込み失敗",
    viewHistory: "同期履歴を表示",
    triggerPull: "今すぐ Peer から取得",
    triggerPush: "今すぐ Peer へ送信 (WS 接続が必要)",
    pullSuccess: "{name} の取得に成功",
    pullFailed: "取得失敗",
    pushSuccess: "{name} への送信に成功",
    pushFailed: "送信失敗",
    pushConfirmTitle: "送信プレビュー → {name}",
    pushConfirmSince: "{time} 以降のローカル変更",
    pushConfirmSinceFull: "全件送信 (初回同期)",
    pushConfirmLWWNote: "Peer 側は LWW でマージ: より新しい Peer 側レコードは上書きされません",
    pushConfirmEmpty: "送信する変更はありません",
    pushConfirmAction: "✓ 送信確認",
    pushConfirmType_group: "Provider",
    pushConfirmType_subgroup: "サブグループ関連",
    pushConfirmType_alias: "別名",
    pushConfirmType_key: "API Keys",
    pushConfirmType_setting: "システム設定",
    pushConfirmAffectedTotal: "{n} 件の変更を送信します",
    pushConfirmExpandAll: "すべて展開",
    pushConfirmCollapseAll: "すべて折りたたむ",
    pullConfirmYes: "取得を確認",
    pullConfirmHint: "{name} から最新データを取得し、LWW でローカルにマージします。続行しますか?",
    triggerDisabledNotConnected: "Peer が未接続のため同期できません",
    relJustNow: "たった今",
    relMinAgo: "{n} 分前",
    relHourAgo: "{n} 時間前",
    relDayAgo: "{n} 日前",
  ...
  upgrade: {
    localUpgradeBtn: "更新",
    localUpgradeBtnWithVersion: "{v} に更新",
    localUpgradeTip: "GitHub に新バージョンあり, クリックで更新コマンドを表示",
    alreadyLatest: "最新です",
    copyCmdTitleHasNew: "新バージョン: {v}",
    copyCmdTitleAlreadyLatest: "既に最新",
    copyCmdBody: "{from} → {to} 更新. デプロイ先で実行:",
    copyCmdBodyAlreadyLatest: "現在の {v} は GitHub 最新. 強制再 pull する場合:",
  ...
  playground: {
    newSession: "新しい会話",
    pickerLabel: "model / provider を選択",
    pickerSearchPlaceholder: "model / provider を検索",
    noProviders: "利用可能な group/alias がありません。Aliases で先に作成してください",
    noMatch: "該当なし",
    deleteConfirm: "この会話を削除?",
    emptyConversation: "空の会話。下に入力して開始",
    emptyNoActive: "左で新しい会話を開始",
    defaultTitle: "新しい会話",
    phaseThinking: "思考中",
    phaseStreaming: "応答中",
    thinkingHeader: "推論プロセス ({n} 文字)",
    systemPromptPlaceholder: "System prompt(任意、空欄なら送信しない)",
    composePlaceholder: "Shift+Enter 改行、Enter 送信",
    send: "送信",
    sending: "送信中…",
    loadModelsFailed: "モデル一覧の取得失敗: {msg}",
    emptyResponse: "(空の応答)",
    ...
    modalityVideoLabel: "動画",
    metaFirstByte: "初回 {dur}",
    metaTotal: "合計 {dur}",
    metaTok: "in {in} / out {out} tok",
    metaTokRate: "{rate} tok/s",
    attachImage: "画像追加",
    attachmentRemove: "削除",
    attachmentTooLarge: "{name} 大きすぎ ({size})、上限 {max}",
    attachmentReadFailed: "{name} 読み込み失敗",
    fileProtocolWarning:
      "このページは file:// で開かれているため、すべてのバックエンドリクエスト (/api、/proxy) を送信できません — 画像生成やモデル一覧などは失敗します。api-center のバックエンド URL (例: http://localhost:3001/) 経由で開いてください。",
    invalidJsonResponse: "上流が JSON として解析できないレスポンスを返しました",
    recentImages: "最近の画像",
    uploadNew: "ローカルから追加",
    noRecentImages: "画像履歴なし",
    settings: "パラメータ",
    allProviders: "すべて",
    sectionAliases: "別名",
    sectionModels: "モデル",
    ...
    historyModeAll: "全部",
    historyModeNone: "なし",
    historyModeManual: "手動",
    historyModeAllHint: "全履歴を含める",
    historyModeNoneHint: "現在のメッセージのみ",
    historyModeManualHint: "直近 N 件の履歴を含める",
    historyManualLabel: "直近件数",
    pastedImage: "ペーストされた画像",
    viewList: "リスト表示",
    viewGrid: "カード表示",
    colName: "名前",
    colType: "タイプ",
    colProvider: "プロバイダ",
    colDescription: "関連モデル",
    groupByKind: "タイプ別グループ化",
    aliasTag: "別名",
    freeTag: "無料",
    filterAll: "全部",
    filterFreeOnly: "無料のみ",
    showAllModels: "全モデル表示",
    showAllModelsHint: "ホワイトリスト無視、上流が宣言した全モデル",
    manualInputLabel: "手動入力",
    manualInputPlaceholder: "モデル名を入力(リストになくても試せる)",
    manualInputBtn: "使用",
    pickProviderFirst: "先にプロバイダを選択",
  },
};
