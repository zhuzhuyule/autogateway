export default {
  ...
  modelcatalog: {
    ...
    freeOnly: "無料のみ",
    freeTag: "無料",
    statsLine: "総数 {total} · 表示 {filtered} · 無料 {free}",
  },
  dedup: {
    title: "モデル重複排除",
    modelName: "モデル名",
  ...
  v3: {
    ...
    newGroupSubPick: "無料 Provider を選んで開始",
    newGroupSubPicked: "設定完了。Key を取得して貼り付けると自動テストします。",
    ...
    step3Title: "貼り付けて有効化",
    step3Sub: "保存前にテスト実行",
    getKeyTitle: "{provider} から無料 Key を取得",
    getKeyOpensIn: "新しいタブで開く",
    getKeyHint: "サインイン後「Create new secret key」をクリックし、戻って貼り付けてください。",
    freeTier: "無料枠",
  ...
  v5: {
    ...
    noKeysSubWithProvider: "Provider から無料の key を取得して貼り付けてください。",
