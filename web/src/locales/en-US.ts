export default {
  ...
  sync: {
    ...
    identityHint: "Share this fingerprint with the peer admin so they can pin it when adding you as a peer — protects against MITM and impersonation. Private key never leaves this machine.",
