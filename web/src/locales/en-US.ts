export default {
  ...
  aliases: {
    ...
    // View modes: one dataset, four presentations
    view_cards: "Cards",
    view_table: "Table",
    view_split: "Split",
    view_health: "Health",
    ...
    split: {
      ...
      pick: "Pick an alias on the left.",
      reserved: "smart routing",
      summary: "{usable}/{total} usable",
    ...
    health: {
      ...
      statUsable: "Usable",
      statUnusable: "Unusable",
      allGood: "All {n} aliases are healthy.",
      emptyTitle: "Aliases with no candidates",
      healthyTitle: "All healthy",
      enable: "Enable",
      open: "Open",
      hint_unexposed:
        "The group is in specified mode but this model is not exposed - routing skips it.",
      hint_blocked: "This model is on the group's blocklist; rejected regardless of routing mode.",
      hint_disabled: "Candidate is manually disabled and not routed.",
      hint_empty: "This alias has no candidates - calls to it will 404.",
    },
    // Edit drawer (AliasEditDrawer.vue)
    edit: {
      title: "Edit alias",
