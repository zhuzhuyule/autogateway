export default {
  ...
  keys: {
    ...
    providerPickerTip: "Click a card to prefill all fields. You only need to paste your own API key afterwards.",
    ...
    providerAdded: "Added",
    providerAlreadyUsed: "{name} already has a group; a copy will be created (suffix -2, edit as needed)",
  ...
  autoroute: {
    ...
    routeTesterTip: "Pick a configured model and paste a request body to see how it would be routed",
  ...
  v3: {
    ...
    autoRoutingDesc: "Cheap path for simple prompts. Flagship only when it pays off. Each model can be mapped to a different group per tier.",
    complexityThresholds: "Complexity thresholds",
    complexityThresholdsSub: "token count → tier",
    addNewMappingTitle: "Add model mapping",
    addNewMappingSub: "Map a model name to one group per tier. Auto-routing picks the tier from token count.",
