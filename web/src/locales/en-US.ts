export default {
  ...
  sync: {
    ...
    syncKey: "Sync Key (Peer Token)",
    syncKeyHint: "Must match the token defined on the peer side",
    syncApiKeys: "Sync API Keys",
    apiKeysWarningTitle: "DANGER: Cross-node API Key sync",
    apiKeysWarningBody:
      "All your API Keys will be pushed (encrypted) to the peer. If the peer or its SyncKey is compromised, every upstream credential is exposed. Only enable this between fully trusted nodes you operate yourself.",
    confirmPhrasePrompt: "Type the confirmation phrase below to enable saving:",
    confirmPhraseError: "Confirmation phrase mismatch — save blocked",
    status: "Status",
