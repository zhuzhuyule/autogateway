export default {
  ...
  v3: {
    ...
    aliasDeleteConfirm: "Remove {alias} → {model} from the alias pool?",
  },
  v5: {
    ...
    aggregatesSub: "auto-managed · permanent · share AUTH_KEY",
    aggregatesEmpty: "No sub-groups yet — add some in Groups & Keys.",
